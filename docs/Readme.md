...
<figure>
  <figcaption style="font-size:0.9em; margin-bottom:8px;">
    ...
    <em>Flat terrain and south‑facing slopes show the greatest canopy reduction, while the lowest elevation band experienced extreme loss; statistics were derived from the dCHM and LiDAR‑generated terrain products, excluding the cleared western zone.</em>
  </figcaption>
